...
- `list_posts` — captions in the table rows
- `export_posts` — captions inside the exported rows
- `get_account_report` — a summary built over third-party captions and transcripts
